...
#
# 0.5. re-filter by the REFSEQ PEP data
#
...
#Rscript ${refinery_bin}/filter_75_square.R ${SEARCHPATH}/filters/contigs_after_refseq_pep.llist ${SEARCHPATH}/filters/blat_pep_genome.best.tsv ${SEARCHPATH}/filters/filter4_genome_keepers.list
...
#tcover_filter.sh
#echo "  filtering contigs using BLAT GENOME alignment..." >&2
blat -t=dna ${reference_genome} -q=dna ${SEARCHPATH}/filters/contigs_after_refseq_dna.fa ${SEARCHPATH}/filters/blat_reseq_dna_genome.psl
cat ${SEARCHPATH}/filters/blat_reseq_dna_genome.psl | ${refinery_blatparser} > ${SEARCHPATH}/filters/blat_reseq_dna_genome.best.tsv
Rscript ${refinery_bin}/filter_75_square.R ${SEARCHPATH}/filters/contigs_after_refseq_dna.llist ${SEARCHPATH}/filters/blat_reseq_dna_genome.best.tsv ${SEARCHPATH}/filters/filter5_genome_keepers.list
include_mf ${SEARCHPATH}/filters/raw_contigs.fa ${SEARCHPATH}/filters/contigs_after_genome2.fa ${SEARCHPATH}/filters/filter5_genome_keepers.list
makellist ${SEARCHPATH}/filters/contigs_after_genome2.fa >${SEARCHPATH}/filters/contigs_after_genome2.llist
